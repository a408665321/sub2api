...
> [!NOTE]
> 这是一个非官方的社区维护发行版。活跃开发基于
> [`custom/main`](https://github.com/a408665321/sub2api/tree/custom/main)，`main`
> 用于同步上游。相关入口：[版本发布](https://github.com/a408665321/sub2api/releases)、
> [GHCR 镜像](https://github.com/a408665321/sub2api/pkgs/container/sub2api)、
> [Issues](https://github.com/a408665321/sub2api/issues)、
> [Discussions](https://github.com/a408665321/sub2api/discussions) 和
...
- **商业使用与许可证**：本项目允许商业使用，但必须遵守 GNU 宽通用公共许可证 v3.0 或更高版本的全部适用条件。许可证不代表上游或社区维护者对任何商业服务的认可；使用者仍须自行确保符合法律法规及上游服务条款。
